...
namespace ProxyDupeRemover
{
    ...
    {
        /* 
         * ProxyDupeRemover v0.2 
         * - added a file checker to prevent errors.
         * - added delegated threading to the functions. 
         */
        static void Main(string[] args)
        {
            ...
            {
                Console.SetCursorPosition(0, Console.CursorTop);   // - Move cursor
                Console.WriteLine("Proxies.txt does not exist in the current directory!");
                Console.ReadLine();
            }
        }
    }
